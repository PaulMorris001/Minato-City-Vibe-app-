...
- Mobile: `app/negotiate-ticket/[eventId].tsx`, `app/ticket-offer/[id].tsx`, `services/ticketOffer.service.ts`; `ticket_offer` cards in `components/chat/MessageBubble.tsx`. Web discovery hands negotiation into the app, like product/service chats.
