...
<head>
  ...
  <title>Child Safety Policy – OurCityvibe</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="section">
      <h2>Reporting</h2>
      <p>If you encounter any content or behavior that you believe violates this policy, please report it immediately to support@ourcityvibe.com. We review all reports promptly and will report confirmed CSAE content to the National Center for Missing and Exploited Children (NCMEC) and relevant law enforcement authorities.</p>
    </div>
    ...
    <div class="section">
      <h2>Contact</h2>
      <p>For questions or concerns related to child safety on our platform, contact us at support@ourcityvibe.com.</p>
    </div>
  </div>
</body>
</html>`;
