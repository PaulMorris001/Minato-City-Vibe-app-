...
module.exports = {
  ...
  scheme: "mobile",
  // Follows the device scheme so system materials (Liquid Glass tab bar,
  // sheets, alerts) match the in-app light/dark theme, which defaults to
  // "system" (see contexts/ThemeContext.tsx).
    ...
    [
      "expo-location",
      {
        locationWhenInUsePermission:
          "OurCityvibe uses your location to show events and guides near you.",
      },
    ],
    [
      "expo-camera",
